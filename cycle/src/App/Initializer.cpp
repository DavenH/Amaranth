...
void Initializer::instantiate() {
	...
	EnvelopeInter2D* envInter2D;
	MorphPanel* morphPanel;
	CycleUpdater* updater;
	...
	repo->add(morphPanel 	= new MorphPanel	(repo));
