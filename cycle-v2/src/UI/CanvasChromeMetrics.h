...
inline constexpr float legendFontSize = 11.f;
inline constexpr float legendHorizontalInset = 10.f;
inline constexpr float legendLineLength = 14.f;
inline constexpr float legendLineWidth = 2.f;
inline constexpr float legendTextGap = 6.f;
inline constexpr float legendTextHeight = 20.f;
