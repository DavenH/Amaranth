...
public:
    ...
    void copyElements(vector<TrilinearCube*>& copyCubesTo) const { copyCubesTo = cubes; }
    void copyElements(vector<Vertex*>& copyVertsTo) const   { copyVertsTo = verts; }

    void copyElements(vector<Vertex*>& copyVertsTo, vector<TrilinearCube*>& copyCubesTo) const {
