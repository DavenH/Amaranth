...
- The follow-up annotation refinement enlarges the complete spy badge by 44%
  over its original size while retaining the same proportional zoom response,
  restoring legibility without overpowering the cable at the reference zoom.
